...
export default config=>{
    ...
    return {
        scroll: {
            // 滚动
            createContext({condition = {}, props = {}, api, pageDataProps = {}, dataMapper,
                afterMerge = d=>d,
                afterFetch = d=>d} = {}){
        ...
        // 非滚动
        pagination: {
            createContext({condition = {}, props = {}, api, dataMapper} = {}){
